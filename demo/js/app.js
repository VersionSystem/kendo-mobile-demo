	...
	app.initScheduler = function _initScheduler() {
		$("#scheduler").kendoScheduler({
			...
			views: [{
					...
					type: "week",
					selectedDateFormat: "{0:ddd,MMM dd,yyyy} - {1:ddd,MMM dd,yyyy}"
				},
				"month", {
					type: "agenda",
					selectedDateFormat: "{0:ddd, M/dd/yyyy} - {1:ddd, M/dd/yyyy}"
				}
			],
			mobile: "phone",
			timezone: "Etc/UTC",
...
function showDoctor(e) {
	console.log("paras:", e.view.params);
	$("#doctorBar").data("kendoMobileNavBar").title(e.view.params.uid);
}
...
function changeTitle(e) {
	console.log("show..");
	//console.log("title:",$("#testbar").data("kendoMobileNavBar"));
	//$("#testbar").data("kendoMobileNavBar").title("Dr.Liu");
	$("#mytitle").html("Dr.Liu");
	//$("#testbar").data("kendoMobileNavBar").centerElement.context.innerText="Dr.Liu";
}
		...
		success: function fbs_click1(data) {
			...
			$("#testScheduler").kendoScheduler({
				...
				editable: {
					...
					//resize: true
					mode: "popup",
					template: kendo.template($("#patientEditorTemplate").html(), {
						useWithBlock: false
					})
				},
